...
export const footerData = {
  links: [
    {
      title: 'Productos',
      links: [
        { text: 'Aplicación web', href: 'https://app.acontplus.com/Index' },
        { text: 'POS AcontPlus', href: 'https://restaurant.acontplus.com/auth' },
      ],
    },
    {
      title: 'App Facturación',
      links: [{ text: 'Acerca de nosotros', href: '#' }],
    },
    {
      title: 'Soporte',
      links: [
  ...
  secondaryLinks: [
    { text: 'Terms', href: getPermalink('/politicas-de-privacidad-y-proteccion-de-datos-personales') },
