...
excerpt: 'Exploring eCommerce search with the Pod Foods wholesale grocery distribution catalog. Checkout the live demo at podfoods.trieve.ai .'
...
Pod Foods is not our customer, but we've built out a live demo [available at podfoods.trieve.ai](https://podfoods.trieve.ai) with a limited mockup of their website to showcase and test Trieve for eCommerce!
