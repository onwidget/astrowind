...
import LearnMoreBox from '../../components/common/LearnMoreBox.astro';
...
TextBox: All the code used (both node.js and Python) is also in this repo: ____. 
...
<TextBox>
[Firecrawl Docs](https://docs.firecrawl.dev/features/crawl) & Github: [js-sdk](https://github.com/mendableai/firecrawl/tree/main/apps/js-sdk) and [python-sdk](https://github.com/mendableai/firecrawl/tree/main/apps/python-sdk)
</TextBox>

We use firecrawl to convert the pages on `https://signoz.io/docs/` into markdown then save them to a json file (with a timestamp). You can adjust the crawler limit, but there are only 303 pages so it falls within the free credits plan.
...
TextBox / called: See the docs: [Create or Upsert Chunk or Chunks](https://docs.trieve.ai/api-reference/chunk/create-or-upsert-chunk-or-chunks)
...
#### [Search Playground at search.trieve.ai](https://search.trieve.ai/)
...
![image](https://hackmd.io/_uploads/HJlVdkVsR.png)
...
![image](https://hackmd.io/_uploads/SksYEkVj0.png)
...
![image](https://hackmd.io/_uploads/BydbEyVsA.png)
...
![image](https://hackmd.io/_uploads/B1cXEk4jA.png)

#### [RAG Playground at chat.trieve.ai](https://chat.trieve.ai/)
...
<LearnMoreBox>
HyDE is... https://arxiv.org/abs/2212.10496
</LearnMoreBox>
...
![image](https://hackmd.io/_uploads/rJfody4jR.png)
