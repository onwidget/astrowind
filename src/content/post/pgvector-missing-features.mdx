...
Trieve and other search solutions, in contrast, are going to be easy. You can try it yourself on our [hacker news search engine](https://hn.trieve.ai) and see that on large datasets (up to billions of documents), Trieve's handling of segments and scale gaurantees that filters and order by's are 0 cost.
...
We are always happy to chat search outside outside of Trieve as a solution. If you have further questions, please book a [meeting with me here](https://cal.com/nick.k), join us on [discord and chat async](https://discord.gg/E9sPRZqpDT), or send us an email at [humans@trieve.ai](mailto:humans@trieve.ai).
