    ...
    return function ({ addBase, addUtilities, addComponents }) {
      addBase({
        ...
        '.dark': {
          ...
          '--ph-color-muted': 'rgb(180, 188, 208)',
      ...
      addComponents({
        ...
        '.btn-link': {
          '@apply border-none shadow-none p-0 text-muted hover:text-primary dark:hover:text-white dark:hover:text-white hover:underline':
            {},
        },
        ...
        '.btn-sm': {
          '@apply ml-2 py-2.5 px-5 md:px-6 text-sm': {},
        },
      });
    };
  },
