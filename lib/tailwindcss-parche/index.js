    ...
    return function ({ addBase, addUtilities, addComponents }) {
      addBase({
        html: {
          ...
          '--ph-color-primary': 'rgb(6 107 184)',
      ...
      addComponents({
        ...
        '.btn-link': {
          '@apply border-none shadow-none p-0 md:p-0 text-muted hover:text-primary dark:hover:text-white dark:hover:text-white hover:underline':
            {},
        },
      });
    };
